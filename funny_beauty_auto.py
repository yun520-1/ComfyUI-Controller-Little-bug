...
SCENARIOS = [
    {
        "title": "化妆前后",
        "prompt": "funny cartoon style, beautiful girl comparing makeup before and after, left side messy hair no makeup, right side glamorous with perfect makeup, exaggerated contrast, humor, bright colors, comic style, 4k, highly detailed",
        "negative": "blurry, low quality, dark, serious, realistic, nsfw, ugly, deformed, watermark, text"
    },
    {
        "title": "自拍 vs 他拍",
        "prompt": "funny cartoon style, beautiful girl taking selfie vs someone else taking photo, selfie shows perfect angle, other photo shows funny awkward angle, exaggerated expressions, humor, bright, comic, 4k",
        "negative": "blurry, low quality, dark, serious, nsfw, ugly, deformed, watermark, text"
    }
]
